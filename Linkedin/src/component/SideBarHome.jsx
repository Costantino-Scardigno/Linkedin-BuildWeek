    ...
    <div className="d-flex flex-column col-3 mt-4 ">
      ...
      <div className="card rounded-4 mb-3">
        <div className="card-body text-center">
          <a
            href="/in/filippo-boesso-113a42342"
          ...
          <button
            className="btn btn-primary btn-sm position-relative rounded-circle mb-3"
          ...
          <div>
            ...
            <p className="card-text text-muted small">
              Personal trainer certificato presso privato
            </p>
      ...
      <div className="card rounded-4 mb-3">
        <div className="card-body">
          ...
          <a
            ...
            className="btn btn-link text-start p-0 mt-2 d-flex align-items-center text-decoration-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
